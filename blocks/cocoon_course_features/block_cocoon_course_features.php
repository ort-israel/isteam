        ...
        <div class="feature_course_widget">
          <ul class="list-group">
            ...
            <li class="d-flex justify-content-between align-items-center">
                '.get_string('lectures', 'block_cocoon_course_features').' <span class="float-right">'. format_text($this->content->lectures, FORMAT_HTML, array('filter' => true)) .'</span>
            </li>
            <li class="d-flex justify-content-between align-items-center">
                '.get_string('quizzes', 'block_cocoon_course_features').' <span class="float-right">'. format_text($this->content->quizzes, FORMAT_HTML, array('filter' => true)) .'</span>
            </li>
            <li class="d-flex justify-content-between align-items-center">
                '.get_string('duration', 'block_cocoon_course_features').' <span class="float-right">'. format_text($this->content->duration, FORMAT_HTML, array('filter' => true)) .'</span>
            </li>
            <li class="d-flex justify-content-between align-items-center">
                '.get_string('skill_level', 'block_cocoon_course_features').' <span class="float-right">'. format_text($this->content->skill_level, FORMAT_HTML, array('filter' => true)) .'</span>
            </li>
            <li class="d-flex justify-content-between align-items-center">
                '.get_string('language', 'block_cocoon_course_features').' <span class="float-right">'. format_text($this->content->language, FORMAT_HTML, array('filter' => true)) .'</span>
            </li>
            <li class="d-flex justify-content-between align-items-center">
                '.get_string('assessments', 'block_cocoon_course_features').' <span class="float-right">'. format_text($this->content->assessments, FORMAT_HTML, array('filter' => true)) .'</span>
            </li>
          </ul>
        </div>';
        return $this->content;
