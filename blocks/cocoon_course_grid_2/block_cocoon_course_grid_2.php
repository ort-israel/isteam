...
$this->content->text .='
      ...
      <div class="col-lg-6 offset-lg-3">
        <div class="courses_all_btn text-center">
          <a class="btn btn-transparent" data-ccn-c="color_btn" data-ccn-co="content" data-ccn="button_text" href="'.format_text($this->content->button_link, FORMAT_PLAIN, array('filter' => true)).'" style="color:'.$this->content->color_btn.'">'.format_text($this->content->button_text, FORMAT_HTML, array('filter' => true)).'</a>
        </div>
      </div></div>'  ;
      }
$this->content->text .='
