...
if ($numberofslides) { ?>
    ...
    ?>
        ...
        <a class="left carousel-control" href="#homepageCarousel" data-slide="prev"><i class="fa fa-chevron-right"></i></a><!-- Tsofiya 21/08/2017 :<i class="fa fa-chevron-left">-->
        <a class="right carousel-control" href="#homepageCarousel" data-slide="next"><i class="fa fa-chevron-left"></i></a><!-- Tsofiya 21/08/2017 : <i class="fa fa-chevron-right">-->
