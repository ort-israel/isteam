...
<header id="header">
        ...
        <div class="container-fluid">
            <div class="header-logo">
                <a href="<?php echo $CFG->wwwroot; ?>">
                    <img src="<?php echo theme_eguru_get_logo_url(); ?>" width="347" height="104" alt="iSTEAM">
                </a>
            </div>
            <div class="header-other-logos">
                <a href="http://www.wohl.org.uk">
                    <img class="other-logos ort-logo" src="<?php echo $OUTPUT->image_url('wohl-logo', 'theme'); ?>"
                         width="155" height="67"
                         alt="iSTEAM">
                </a>
                <a href="http://www.ort.org.il">
                    <img class="other-logos wohl-logo" src="<?php echo $OUTPUT->image_url('ort-logo', 'theme'); ?>"
                         width="206" height="83"
                         alt="iSTEAM">
                </a>
            </div>
    ...
    <?php
    if (isloggedin() and !isguestuser() and $PAGE->pagelayout != 'frontpage') { ?>
