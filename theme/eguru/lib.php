 ...
 */
function section_nav_selection($course, $displaysection = 1) {
    global $OUTPUT;
    ...
    $section = 1;
    // Get full course info (including numsections).
    // (as $course param is lacking some key info).
    $course = course_get_format($course)->get_course();
    /* Tsofiya 24/08/2017: Define $numsections because $course->numsections not exist in current (moodle3.3) $course
       We get the number of sections of the course from $modinfo->sections, and decrease 1 because it counts also section 0,
       that is a default section (and doesn't have conyent of the course).
    */
